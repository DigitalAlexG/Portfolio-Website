...
export default function Page() {
  ...
  return (
    <React.Fragment>
      ...
      <div className="flex flex-col items-center justify-center w-full pt-[80px] pb-[80px] mt-4">
        <div className='flex flex-col items-center justify-center bg-[url("/offices.jpg")] bg-cover bg-center w-full h-[400px]'>
          <div className="flex flex-col items-center justify-center  w-full h-full bg-[#223740]/70 backdrop-brightness-50">
            <div className="text-center bg-[#48AFDE] py-[10px] px-[10px] tracking-wide uppercase font-semibold text-[20px] text-white rounded-lg">
              <a href="#contact" className="cursor-pointer">
                <h1 className="recoletaBold text-5xl text-[white] p-2 text-center tracking-wide">
                  Contact Me
                </h1>
              </a>
            </div>
          ...
          <div className="sm:flex gap-[20px] mt-[50px] max-w-[1105px] w-full h-full">
            <div className="flex flex-col flex-1 xl:flex-row gap-[20px]">
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">Kelowna, BC Canada</p>
                </div>
              </div>
            ...
            <div className="flex flex-col flex-1 xl:flex-row gap-[20px]">
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">DigitalAlexG@gmail.com</p>
                </div>
              </div>
      ...
      <div
        className="bg-white max-h-[450px] py-12 lg:px-12 md:px-5 px-3 rounded-lg  "
        style={{
          width: "100%",
        }}
      ></div>
